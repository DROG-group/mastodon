...
import StatusActionBar from 'flavours/glitch/components/status_action_bar';
import StatusContent from 'flavours/glitch/components/status_content';
import StatusIcons from 'flavours/glitch/components/status_icons';
import StatusPrepend from 'flavours/glitch/components/status_prepend';
import { IconButton } from 'flavours/glitch/components/icon_button';

import { GamepatchCard } from 'flavours/tactcheck/features/status/components/gamepatch_card';
...
class Status extends ImmutablePureComponent {
  ...
  render () {
    ...
    // Gamepatch interactive card
    if (status.get('gamepatch_card')) {
      media.push(
        <GamepatchCard
          key={`gamepatch-${status.get('id')}`}
          card={status.get('gamepatch_card')}
        />,
      );
    }
